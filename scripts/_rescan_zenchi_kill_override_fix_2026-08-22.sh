...
OUTDIR=data/verify/zenchi_render_kill_override_fix_2026-08-22
LOGDIR=logs/zenchi_rescan_kill_override_fix_2026-08-22
WARMUP=30
...
echo "=== 30先動画 修正①検証用 全編再走査 start $(date +%F_%T) ==="
echo "[単一情報源] $ADOPTED"
echo "[構成] $FLAGS"
