...
使い方: python scripts/_gate3r5_wipe_window_2026-08-25.py
出力: data/verify/gate3r5_wipe_window_2026-08-25/dump_on.npz
"""
...
OUT_DIR = Path("data/verify/gate3r5_wipe_window_2026-08-25")
END_SEC = "600"
