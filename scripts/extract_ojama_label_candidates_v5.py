"""ラベリング用 grid v5 — v1+v2+v3+v4 既使用を除外して新規 12 枚を抽出。"""
...
OUT_GRID = Path("data/verify/ojama_label_grid_v5.png")
OUT_INDEX = Path("data/verify/ojama_label_index_v5.tsv")
...
def main() -> int:
    ...
    print(f"既使用試合 (v1+v2+v3+v4): {len(existing)}")
