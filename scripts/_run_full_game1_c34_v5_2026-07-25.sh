#!/bin/bash
# レビュー#49 再生成 v5 (2026-07-25): v4 の幽霊B(前試合残骸5field)修正版。
#
...
mkdir -p "${OUT_DIR}"
RAW="${OUT_DIR}/advantage_recog_c34_game1_full_score0to0_v5.mp4"
H264="${OUT_DIR}/advantage_recog_c34_game1_full_score0to0_v5_h264.mp4"
