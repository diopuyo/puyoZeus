"""ラベリング用 grid v3 — v1+v2 既使用を除外して新規 12 枚を抽出。"""
...
OUT_GRID = Path("data/verify/ojama_label_grid_v3.png")
OUT_INDEX = Path("data/verify/ojama_label_index_v3.tsv")
...
def main() -> int:
    ...
    print(f"既使用試合 (v1+v2): {len(existing)}")
