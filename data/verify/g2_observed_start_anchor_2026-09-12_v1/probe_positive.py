...
CHAIN_FIRST, SETTLE_FIRST, END = 96, 100, 112
TOTAL_SCORE = 700
...
def main() -> None:
    ...
    saved = run(real, ROOT / 'positive_full_v1', 'positive', END)
    ...
    with (ROOT / 'POSITIVE_PROBE_v1.json').open('x', encoding='utf-8') as stream:
