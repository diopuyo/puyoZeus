...
probe_log=logs/g2_client_session_contract_v2.log
probe_exit=logs/g2_client_session_contract_v2.exit
...
timeout 1200s ./venv/bin/python data/verify/g2_start_client_session_contract_2026-09-12_v1/probe_session_v2.py prefix_cpu_v134_client_session_contract > "$probe_log" 2>&1 < /dev/null
probe_code=$?
