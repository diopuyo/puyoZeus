...
SC = PREVIOUS.module('_a37_terminal_selection', TERMINAL_SELECTION)
...
def terminal_sources() -> set[Path]:
    ...
    return {TERMINAL / name for name in names} | {TERMINAL_SELECTION, WARNING_SOURCE, TERMINAL_MATH, project / 'src/scoring.py', snapshot / 'src/scoring.py'} | {
