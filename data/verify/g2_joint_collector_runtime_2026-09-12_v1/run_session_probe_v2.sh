...
probe_log=logs/g2_joint_session_probe_v2.log
probe_exit=logs/g2_joint_session_probe_v2.exit
...
timeout 1200s ./venv/bin/python data/verify/g2_joint_collector_runtime_2026-09-12_v1/probe_session_constructor_v2.py prefix_cpu_v63_session_probe > "$probe_log" 2>&1 < /dev/null
probe_code=$?
