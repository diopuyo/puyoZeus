...
runner=data/verify/g2_m1_paced_runtime_2026-09-13_v12/target_entry.py
guard=data/verify/g2_m1_paced_runtime_2026-09-13_v12/resource_guard.py
supervisor=data/verify/g2_m1_paced_runtime_2026-09-13_v12/supervise.py
output=data/verify/video38_m1_paced_candidate_v12
cd "$project"
...
(
  set +e
  taskset -c 3 ./venv/bin/python -u "$supervisor" "$runner" "$output" "$guard"
  final=$?
