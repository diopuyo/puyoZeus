...
SC = PREVIOUS.module('_a40_terminal_selection', TERMINAL_SELECTION)
COMPAT_ROOT = ROOT.parent / 'g2_legacy_m1_compatibility_2026-09-14_v1'
COMPAT = PREVIOUS.module('_a40_legacy_m1_compatibility_selection', COMPAT_ROOT / 'selection.py')
TERMINAL_SAVED = WARNING_SOURCE.parent / 'terminal_saved.py'
INACTIVE_ROOT = ROOT.parent / 'g2_a38_postrun_2026-09-14_v1'
INACTIVE = PREVIOUS.module('_a40_terminal_lifecycle', INACTIVE_ROOT / 'terminal_selection.py')
INACTIVE_SAVED = PREVIOUS.module('_a40_inactive_saved', INACTIVE_ROOT / 'second_inactive_saved.py')
READER_ROOT = ROOT.parent / 'g2_a39_postrun_2026-09-14_v1'
READER = PREVIOUS.module('_a40_terminal_reader', READER_ROOT / 'terminal_reader_selection.py')
CURRENT: E.Runtime | None = None


def sources() -> tuple[Path, ...]:
    return tuple(sorted(set(PREVIOUS.sources()) | terminal_sources() | {READER_ROOT / 'terminal_prefix_reader.py', READER_ROOT / 'terminal_reader_selection.py', ROOT / 'owned_adapter.py', ROOT / 'early_runtime.py',
...
def configured(stack: Any) -> Any:
    ...
    READER.install_owner(stack, sys.modules[A.A.A.V4.OWNED_ALIAS], replace, scope)
