...
TERMINAL_SELECTION = ROOT.parent / 'g2_second_terminal_arrival_2026-09-14_v2/session_selection.py'
SC = PREVIOUS.module('_a36_terminal_selection', TERMINAL_SELECTION)
...
def terminal_sources() -> set[Path]:
    ...
    return {TERMINAL / name for name in names} | {TERMINAL_SELECTION} | {
