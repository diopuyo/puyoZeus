...
BASE = ROOT / 'g2_side_lease_connection_2026-09-11_v1'
CANDIDATE = Path(__file__).resolve().parent
PINS = {
    'g2_side_lease_connection_2026-09-11_v1/side_lease.py': '08c7c3453b6c9e39e95948fe4126410649ce739560e87a37ab752201a4a7853b',
    'g2_historical_chain_next_reset_2026-09-12_v1/selected_side_lease.py': 'd2e395d9a9d383c123b6d17fc36ec9e3b91db23483b97e64b75738ffe986b2b7',
}
...
def selected() -> Any:
    ...
    old = L.load('_g2_actual_side_lease_base', BASE / 'side_lease.py')
    return L.load('_g2_actual_side_lease_selected', CANDIDATE / 'selected_side_lease.py', {'side_lease': old})
