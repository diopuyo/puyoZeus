...
SC = PREVIOUS.module('_a38_terminal_selection', TERMINAL_SELECTION)
COMPAT_ROOT = ROOT.parent / 'g2_legacy_m1_compatibility_2026-09-14_v1'
COMPAT = PREVIOUS.module('_a38_legacy_m1_compatibility_selection', COMPAT_ROOT / 'selection.py')
...
def terminal_sources() -> set[Path]:
    ...
    return {TERMINAL / name for name in names} | {TERMINAL_SELECTION, WARNING_SOURCE, TERMINAL_MATH, TERMINAL_SAVED, COMPAT_ROOT / 'selection.py', COMPAT_ROOT / 'compatibility.py', project / 'src/scoring.py', snapshot / 'src/scoring.py'} | {
