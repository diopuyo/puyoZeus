...
ROOT = OLD.ROOT
OUT = ROOT / 'replayed_projection_v2'
TARGET_FRAME = 35672
...
def main() -> None:
    ...
    paths = (Path(__file__), ROOT / 'projected_view.py', ROOT / 'prefix_projection.py',
        ROOT / 'projection_origin_selector.py')
    result = dict(projections=captured, whole_saved_prefix_replayed=True, candidate_replayed=True,
        target_call_frame=TARGET_FRAME, wrong_phase_rejected=True, current_and_ledger_unchanged=True,
