...
def test_projected_callback_through_original_runtime_patch_install(monkeypatch: Any, tmp_path: Path) -> None:
    prepare(monkeypatch)
    ...
    with ExitStack() as stack:
        ...
        state = B.install(stack, bootstrap, replace, prefix_lease=lease)
