...
def test_collect_lean_signature_has_sample_interval_frames_appended_at_tail() -> None:
    ...
    # 注記 (2026-08-17 発見・W23根治タスクで是正、W25根治タスクで2度シフト):
    # 以下のインデックスは enable_override_color_guard /
    # enable_ojama_column_stack_fix / enable_next_history_starvation_fix /
    # enable_ojama_cnn_override_warmup / enable_ojama_write_accounting_guard
    # の5件が末尾にさらに追加された分、元の値から一律 -5 シフトしてある
    # (旧値は git log 参照)。
    ...
    assert params[-1] == "enable_ojama_write_accounting_guard"
