...
def test_collect_lean_signature_has_sample_interval_frames_appended_at_tail() -> None:
    ...
    burst_chain_gap_max_sec / enable_online_hsv_refresh が末尾に順次
    optional 追加され、既存引数の並び・デフォルト値が一切変わっていない
    こと (backwards compat)。
    """
    import inspect
    mod = _import_lean()
